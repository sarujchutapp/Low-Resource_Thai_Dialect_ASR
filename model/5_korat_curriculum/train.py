...
class CustomDataset(torch.utils.data.Dataset):
 ...
 # Use phase 1 for initial training, then phase 2 for fine-tuning
TRAIN_CSV_FILE = os.path.join(CSV_DIR, "train_phase1.csv")
...
with open(TRAIN_CSV_FILE, "r", encoding="utf-8") as f:
    ...
    for row in reader:
        ...
        count_row += 1
print(f"Original training samples: {count_row}")
print(f"Total training samples after speed perturbation: {len(train_data_list)}")
